...
## Table of Contents
1. [The Concept of a Hart (Hardware Thread)](#1-the-concept-of-a-hart-hardware-thread)
2. [The RV32I Register File](#2-the-rv32i-register-file)
3. [Instruction Formats](#3-instruction-formats)
4. [Code Generation Patterns](#4-code-generation-patterns)
5. [Privilege Levels](#5-privilege-levels)
6. [Memory Model: Fences](#6-memory-model-fences)
7. [Physical Memory Protection (PMP)](#7-physical-memory-protection-pmp)
8. [Compressed Instructions (The 'C' Extension)](#8-compressed-instructions-the-c-extension)
9. [Atomic Memory Operations (The 'A' Extension)](#9-atomic-memory-operations-the-a-extension)
10. [Interrupt Architecture](#10-interrupt-architecture)
11. [Advanced Interrupt Handling & Modes](#11-advanced-interrupt-handling--modes)
12. [NMI (Non-Maskable Interrupt) vs. Normal Interrupts](#12-nmi-non-maskable-interrupt-vs-normal-interrupts)
13. [Interrupt Propagation Flow: IO to ISR](#13-interrupt-propagation-flow-io-to-isr)
14. [Full Interrupt Path Diagram](#14-full-interrupt-path-diagram)
...
## 12. NMI (Non-Maskable Interrupt) vs. Normal Interrupts
...
## 13. Interrupt Propagation Flow: IO to ISR
...
## 14. Full Interrupt Path Diagram
